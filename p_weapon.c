...
void Weapon_Blaster_Fire (edict_t *ent)
{
	...
	// Original vector values: (tempvec, 0, 8, 0); (tempvec, 0, -8, 0); positive y-values are to the right
	VectorSet(tempvec, 0, 0, 1);
	VectorAdd(tempvec, vec3_origin, tempvec);
	Blaster_Fire (ent, tempvec, damage, false, EF_BLASTER);

	VectorSet(tempvec, 0, 0, 2);
	VectorAdd(tempvec, vec3_origin, tempvec);
	Blaster_Fire (ent, tempvec, damage, false, EF_BLASTER);
	...
	VectorSet(tempvec, 0, 1, 0);
	VectorAdd(tempvec, vec3_origin, tempvec);
	Blaster_Fire (ent, tempvec, damage, false, EF_BLASTER);

	VectorSet(tempvec, 0, 1, 1);
	VectorAdd(tempvec, vec3_origin, tempvec);
	Blaster_Fire (ent, tempvec, damage, false, EF_BLASTER);

	VectorSet(tempvec, 0, 1, 2);
	VectorAdd(tempvec, vec3_origin, tempvec);
	Blaster_Fire (ent, tempvec, damage, false, EF_BLASTER);
